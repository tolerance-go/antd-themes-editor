    ...
    (0, _createClass3['default'])(Tree, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                _rcTree2['default'],
                (0, _extends3['default'])({}, props, { className: (0, _classnames2['default'])(!showIcon && prefixCls + '-icon-hide', className), checkable: checkable ? React.createElement('span', { className: prefixCls + '-checkbox-inner' }) : checkable, switcherIcon: this.renderSwitcherIcon }),
                this.props.children
            );
        }
    }]);
